...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(244,247,251); }"
                      ...
                      "QDoubleSpinBox { background: rgb(214,213,212); color: rgb(240,241,245); border-color: rgb(194,194,194); }"
                      "QLineEdit      { background: rgb(214,213,212); color: rgb(240,241,245); border-color: rgb(194,194,194); }"
                      "QTextEdit      { background: rgb(214,213,212); color: rgb(240,241,245); }"
                      "QPlainTextEdit { background: rgb(214,213,212); color: rgb(240,241,245); }"
                      ...
                      "QToolButton:checked { color: rgb(240,241,245); border: none; border-left-color: rgb(116,116,116); border-left-style: solid; border-left-width: 6px; }"
